...
$(document).ready(function() {
    ...
    function s(e) {
        ...
        d($(".h-send-chat").val()), i(), $(".h-send-chat").val(null);
    }
    function d(e) {
        setTimeout(function() {
            ...
            $(".rem-msg").removeClass("rem-msg"), $(".typing").removeClass("typing"), i();
        }, 3e3);
    }
    // function i() {
    ...
    $(".card-option .close-card").on("click", function() {
        ...
        e.parents(".card").addClass("anim-close-card"), e.parents(".card").animate({
            ...
            e.parents(".card").children(".card-block").slideToggle(), e.parents(".card").children(".card-body").slideToggle(), 
            e.parents(".card").children(".card-header").slideToggle(), e.parents(".card").children(".card-footer").slideToggle();
        }, 600), setTimeout(function() {
            e.parents(".card").remove();
        }, 1500);
    }), $(".card-option .reload-card").on("click", function() {
        var e = $(this);
        e.parents(".card").addClass("card-load"), e.parents(".card").append('<div class="card-loader"><i class="pct-loader1 anim-rotate"></div>'), 
        setTimeout(function() {
        ...
        var e = $(this), s = $(e.parents(".card"));
        if (s.toggleClass("full-card"), $(this).children("a").children("span").toggle(), 
        ...
        HandleSubMenuTrigger: function() {
            ...
            if (1 == $(".pcoded-navbar").hasClass("theme-horizontal")) if (d >= 768) {
                ...
                i.off("mouseenter mouseleave").off("click").on("click", function() {
                    ...
                    $(this).addClass("pcoded-trigger"), $(this).children(".pcoded-submenu").slideDown()) : $(this).hasClass("pcoded-trigger") ? ($(this).removeClass("pcoded-trigger"), 
                    $(this).children(".pcoded-submenu").slideUp()) : ($(".pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger").children(".pcoded-submenu").slideUp(), 
                    ...
                    e.stopPropagation(), alert("click call"), 0 === $(this).closest(".pcoded-submenu").length ? $(this).hasClass("pcoded-trigger") ? ($(this).removeClass("pcoded-trigger"), 
            ...
            switch (e.SubMenuTrigger) {
                ...
                $(".pcoded-navbar .pcoded-hasmenu").removeClass("is-hover"), $(".pcoded-inner-navbar .pcoded-submenu > li > .pcoded-submenu > li").on("click", function(e) {
                    e.stopPropagation(), 0 === $(this).closest(".pcoded-submenu").length ? $(this).hasClass("pcoded-trigger") ? ($(this).removeClass("pcoded-trigger"), 
                    $(this).children(".pcoded-submenu").slideUp()) : ($(".pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger").children(".pcoded-submenu").slideUp(), 
                    $(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger").removeClass("pcoded-trigger"), 
                    $(this).addClass("pcoded-trigger"), $(this).children(".pcoded-submenu").slideDown()) : $(this).hasClass("pcoded-trigger") ? ($(this).removeClass("pcoded-trigger"), 
                    $(this).children(".pcoded-submenu").slideUp()) : ($(".pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger").children(".pcoded-submenu").slideUp(), 
        ...
        HandleMenuTrigger: function() {
            ...
            if (1 == $(".pcoded-navbar").hasClass("theme-horizontal")) {
                ...
                d >= 768 ? i.off("click").off("mouseenter mouseleave").hover(function() {
                    ...
                    $(this).hasClass("pcoded-trigger") ? ($(this).removeClass("pcoded-trigger"), $(this).children(".pcoded-submenu").slideUp()) : ($("li.pcoded-trigger").children(".pcoded-submenu").slideUp(), 
                    $(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger").removeClass("pcoded-trigger"), 
                    $(this).addClass("pcoded-trigger"), $(this).children(".pcoded-submenu").slideDown());
                });
            }
